  ...
  return createElement('div', null,
    ...
    selectedDayData && createElement('div', {
      ...
      (() => {
        ...
        const payCards = [
          { key: 'cash', label: '現金', icon: 'payments', count: dayCashEntries.length, total: dayCash, color: 'var(--color-accent)', bg: 'rgba(26,115,232,0.08)', border: 'rgba(26,115,232,0.2)' },
          { key: 'uncollected', label: '未収', icon: 'pending', count: dayUncollectedEntries.length, total: dayUncollected, color: 'var(--color-error)', bg: 'rgba(229,57,53,0.08)', border: 'rgba(229,57,53,0.2)' },
          { key: 'didi', label: 'DIDI', icon: 'smartphone', count: dayDidiEntries.length, total: dayDidi, color: 'var(--color-warning)', bg: 'rgba(255,152,0,0.08)', border: 'rgba(255,152,0,0.2)' },
          { key: 'uber', label: 'Uber', icon: 'hail', count: dayUberEntries.length, total: dayUber, color: '#fff', bg: 'rgba(0,0,0,0.15)', border: 'rgba(255,255,255,0.15)' },
          { key: 'discount', label: '割引', icon: 'discount', count: dayDiscountEntries.length, total: dayDiscount, color: '#ce93d8', bg: 'rgba(156,39,176,0.08)', border: 'rgba(156,39,176,0.2)' },
        ];
        ...
        return createElement(React.Fragment, null,
          ...
          // 現金・未収・DIDI・Uber・割引 カード
          createElement('div', {
            style: { display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '6px', marginBottom: 'var(--space-sm)' }
          },
            ...payCards.map(c =>
              createElement('div', {
                key: c.key,
          ...
          createElement('div', {
            style: {
              padding: '10px 12px', borderRadius: 'var(--border-radius)', marginBottom: 'var(--space-sm)',
