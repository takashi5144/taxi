...
window.APP_CONSTANTS = {
  ...
  KNOWN_LOCATIONS: {
    asahikawa: {
      ...
      hospitals: [
        ...
        { name: '市立旭川病院', lat: 43.7784, lng: 142.3659, peakMorning: null, peakAfternoon: '13:00-15:00' },
  ...
  // サイト構造（開発者ツール用）
  SITE_STRUCTURE: { name: "taxi/", type: "folder", children: [] },
